...
/*
 * Neural thinking indicator with animated dots
 */
const NeuralThinkingIndicator = memo(function NeuralThinkingIndicator() {
  return (
...
/*
 * Brain wave thinking indicator with glow effect
 */
const BrainThinkingIndicator = memo(function BrainThinkingIndicator() {
  return (
  ...
  if (isStreaming || duration === 0) {
    return (
      <span className="flex items-center gap-2">
        <span className="thinking-text-shimmer text-transparent">Thinking</span>
